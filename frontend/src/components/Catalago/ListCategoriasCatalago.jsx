...
import ListagemProdCatalago from "./ListagemProdCatalago";

function ListCategoriasCatalago({selectedCategories}) {
        ...
        <div>
            {filteredCategories && filteredCategories.map((categoria) => (
                ...
                <div className="categories-details" onClick={() => toggleVisibility(categoria.nome_categoria)}>{categoria.nome_categoria}</div>
                    <div>
                        {categoriaVisible[categoria.nome_categoria] && ( <ListagemProdCatalago categoria={categoria}/>)}
                    </div>
                </div> 
            ))}
        </div>
...
export default ListCategoriasCatalago;

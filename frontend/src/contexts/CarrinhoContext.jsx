...
export function CarrinhoProvider({ children }) {
    ...
    return (
        <CarrinhoContext.Provider value={{ produtos, setProdutos, adicionarProduto, atualizarQuantidade, removerProduto, totalCarrinho, produtoModalOpen, setProdutoModalOpen}} >
            {children}

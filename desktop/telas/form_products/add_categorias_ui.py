...
"}")
        ...
        sizePolicy.setHeightForWidth(self.modificar_botao.sizePolicy().hasHeightForWidth())
        self.modificar_botao.setSizePolicy(sizePolicy)
        ...
        self.adicionar_cat_input.setGeometry(QRect(10, 20, 300, 25))
        ...
        self.drop_modificar.setGeometry(QRect(10, 20, 300, 25))
        ...
        self.btn_excluir.setGeometry(QRect(10, 20, 101, 25))
        ...
        self.btn_adicionar.setGeometry(QRect(10, 20, 101, 25))

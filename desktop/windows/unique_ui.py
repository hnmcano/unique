...
"}")
        ...
        self.gridLayout.addWidget(self.frame_9, 1, 3, 1, 1)
...
"}")
        ...
        self.label_39.setPixmap(QPixmap(u":/unique/ifood-logo.png"))
    ...
    def retranslateUi(self, Unique):
        ...
        self.btn_relatorios.setText(QCoreApplication.translate("Unique", u"Configura\u00e7\u00f5es", None))
        ...
        self.label_27.setText(QCoreApplication.translate("Unique", u"Ifood", None))
        self.label_28.setText(QCoreApplication.translate("Unique", u"Ifood", None))
